...
using CashFlow.iOS.Renderers;

[assembly: ExportRenderer(typeof(ModernEntry), typeof(IOSModernEntryRenderer))]
namespace CashFlow.iOS.Renderers
{
    internal class IOSModernEntryRenderer : EntryRenderer
    {
        ...
        {
            if (e.PropertyName == ModernEntry.PaddingProperty.PropertyName)
            {
                UpdatePadding();
            }
